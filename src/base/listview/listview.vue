<template>
	<scroll @scroll = "scroll" class="listview" :data="data" ref="listview" :listen-scroll = "listenScroll"
	:probe-type="probeType" >
		...
		<div class="list-fixed" v-show="fixedTittle" ref="fixed">
...
export default {
	...
	watch: {
		...
		diff(newVal) {
			let fixedTop = (newVal > 0 && newVal < TITLE_HEGHT) ? newVal - TITLE_HEGHT : 0
